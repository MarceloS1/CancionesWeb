...
namespace CancionesWeb.Controllers
{
    ...
    public class CancionesController : ControllerBase
    {
        ...
        // GET: api/Canciones
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Canciones>>> GetCancion()
        {
        ...
        {
            var canciones = await _context.Cancion.FindAsync(id);
        ...
        {
            _context.Cancion.Add(canciones);
            try
            {
                await _context.SaveChangesAsync();
            }
        ...
        public async Task<IActionResult> DeleteCanciones(string id)
        {
            ...
            _context.Cancion.Remove(canciones);
            await _context.SaveChangesAsync();
